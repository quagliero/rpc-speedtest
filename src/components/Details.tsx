...
import type { PrivateKeyAccountWithKey, WalletClientWithKey } from '../types';
...
const Details = ({
  ...
  totalCost: bigint;
  transferCost: bigint;
  initialWallet: WalletClientWithKey;
      ...
      <dl className="mt-4 divide-y divide-gray-200 border-b border-t border-gray-200">
        ...
        <div className={`flex items-center p-2 text-gray-800`}>
          ...
          <dd className="ml-3 min-h-[1.25rem] text-right leading-none">
            {formatEther(totalCost || 0n)} {chain.nativeCurrency.symbol}
            <br />
